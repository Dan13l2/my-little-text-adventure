...
public class IWillRenameThis {
	...
	public static void main (String [] args) {
		...
		int fleeNoDamageChance = 50;
		boolean alive = true;
		
		boolean running = true;
		
		System.out.println ("\t>through many weird circumstances you have come to space!"
				          + "\n\t>congratulations!");
		...
		while(running) {
			...
			while(EnemieHP > 0 && PlayerHP > 0) {
				...
				System.out.println("\tYour money: " + PlayerMoney + " credits");
				...
				if (input.equals("1")) {//attack
					...
					if (rand.nextInt(100) < fleeNoDamageChance ) {// fleeing damage
						System.out.println("\tbut while fleeing the " + Enemy + " shot you in the back");
						int DamageTaken = rand.nextInt(EnemieDP);
						PlayerHP -= DamageTaken;
			...
			System.out.println("\t3. buy repairkit");
			System.out.println("\t4. nope");	
			
			String input = in.nextLine();
			
			while (!input.equals("1") && !input.equals("2") && !input.equals("3") && !input.equals("4")) {
				System.out.println("     pls write 1 2 3 or 4");
				input = in.nextLine();
			}//dont exit
			if (input.equals("1")) {
				...
				if (PlayerMoney > 0) {// enough money
					...
					System.out.println("\tyou dont have enough credits to upgrade your lazor\n");
				}
			}//buy repairkit	
				...
				PlayerMoney--;
				NumRepair++;
				System.out.println("you bought a repairkit");
				System.out.println("you now have: " + NumRepair + " Repairkits");
				}
				else { //not enough money
					System.out.println("\tyou dont have enough credits to buy a repairkit\n");
				}
			}
